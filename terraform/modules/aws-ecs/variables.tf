...
variable "ecs_migrations_log_group_name" {
  description = "Name of CloudWatch log group for ECS migration logs"
  type        = string
}

variable "ecs_application_log_group_name" {
  description = "Name of CloudWatch log group for ECS application logs"
  type        = string
}
...
variable "django_ecs_service_container_name" {
  description = "Django ECS Service container name"
  type        = string
  default     = "container"
}

variable "django_ecs_service_container_port" {
  description = "Django ECS Service container port"
  type        = string
  default     = "8000"
}

variable "django_ecs_tg_name" {
  description = "Django ECS target group name"
  type        = string
  default     = "tg"
}
...
variable "django_container_name" {
  description = "ECS Django App container name"
  type        = string
  default     = "container"
}
